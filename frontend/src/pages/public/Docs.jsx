...
const Docs = () => {
  ...
  const activeSection = useMemo(() => {
    const validSections = new Set(DOC_SECTIONS.map(({ id }) => id));
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            <Link to="/" className="flex items-center space-x-2">
              ...
              <span className="text-xl font-bold text-gray-900">TaxFlow</span>
            </Link>
          ...
          <main className="flex-1 min-w-0">
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-8">
              ...
              <p className="text-gray-600 mb-8">
                Welcome to the TaxFlow documentation. This guide will help you integrate our allocation engine into your application.
              </p>
              ...
              {activeSection === 'overview' && (
                <div className="space-y-6">
                  ...
                  <p className="text-gray-600">
                    The TaxFlow helps you automatically allocate incoming funds across different buckets based on customizable rules.
                  </p>
